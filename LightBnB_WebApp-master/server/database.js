...
const getAllProperties = function (options, limit = 10) {
  // 1 Array of parameters for query
  const queryParams = [];
  // 2 Start of query before WHERE clause
  let queryString = `
  ...
  // 3 Check if parameter is there, then add query onto existing query
  if (options.city) {
